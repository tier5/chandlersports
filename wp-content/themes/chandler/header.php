...
<!--   <link rel="stylesheet" type="text/css" media="all" href="<?=get_stylesheet_directory_uri().'/wc_css.css'?>" /> -->
  ...
  <link href="<?php bloginfo('template_directory'); ?>/changes.css" rel="stylesheet" type="text/css"> 
...
<div class="top_hed">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-3 col-sm-4 open-time1">
      ...
      <div class="col-md-6 col-sm-2 open-time hidden-xs">
      ...
      <div class="col-md-3 col-sm-6 align-right open-time">
        <div class="row">
...
<div class="dropdown">
  ...
  <?php
    ...
    <a href="#">Link 3</a> -->
      ...
      <div class="col-md-2 col-sm-3 header-icon-area">
      <div class="row">
          <div class="col-md-7 col-sm-7 col-xs-6 header-icon-area-left">
          <div class="pull-left top-icon">  
            <!--<i class="fa fa-user" aria-hidden="true"></i>-->
          ...
          <div class="col-md-5 col-sm-5  col-xs-6 header-icon-area-right">
            <div class="pull-left top-icon">  
             <!--<i class="fa fa-shopping-cart" aria-hidden="true"></i>-->
