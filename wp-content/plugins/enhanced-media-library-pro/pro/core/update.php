...
if ( ! function_exists( 'wpuxss_eml_pro_in_plugin_update_message' ) ) {
    ...
    function wpuxss_eml_pro_in_plugin_update_message( $plugin_data, $r ) {
        ...
        echo '<br />' . sprintf(
            __('To unlock updates, please <a href="%s">activate your license</a>. You can get your license key in <a href="%s">Your Account</a>. If you do not have a license, you are welcome to <a href="%s">purchase it</a>.', 'eml'),
...
if ( ! function_exists( 'wpuxss_eml_pro_get_url' ) ) {
    ...
    function wpuxss_eml_pro_get_url() {
        ...
        return 'http://www.wpuxsolutions.com/downloads/plugins/enhanced-media-library-pro/';
    }
}
