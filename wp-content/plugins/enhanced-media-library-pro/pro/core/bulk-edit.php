...
if ( ! function_exists( 'wpuxss_eml_pro_print_media_templates' ) ) {
    ...
    <?php       $wpuxss_eml_tax_options = get_option('wpuxss_eml_tax_options');
        ...
        <?php if ( version_compare( $wp_version, '4.3', '<' ) ) :
            $select_all_button = '<a class="select-all" href="#">' . __( 'Select All', 'eml' ) . '</a>';
            $edit_selection_button = '<a class="edit-selection" href="#">' . __( 'Edit Selection', 'eml' ) . '</a>';
            $deselect_all_button = '<a class="clear-selection" href="#">' . __( 'Deselect All', 'eml' ) . '</a>';
            $delete_selected_button = '<a class="delete-selected" href="#">' . __( 'Delete Selected', 'eml' ) . '</a>';
        else :
            $select_all_button = '<button type="button" class="button-link select-all">' . __( 'Select All', 'eml' ) . '</button>';
            $edit_selection_button = '<button type="button" class="button-link edit-selection">' . __( 'Edit Selection', 'eml' ) . '</button>';
            $deselect_all_button = '<button type="button" class="button-link clear-selection">' . __( 'Deselect All', 'eml' ) . '</button>';
            $delete_selected_button = '<button type="button" class="button-link delete-selected">' . __( 'Delete Selected', 'eml' ) . '</button>';
        endif; ?>
