                        ...
                        if ( ! empty($terms) ){
                            ...
                            switch ($rule->condition) {
                                case 'in':
                                    ...
                                    $this->queryJoin[] = " LEFT JOIN {$this->wpdb->term_relationships} ON ({$this->wpdb->posts}.ID = {$this->wpdb->term_relationships}.object_id)";
                                    $this->queryWhere .= "{$this->wpdb->term_relationships}.term_taxonomy_id IN ($terms_str)";
                                    if ( ! empty($rule->clause)) $this->queryWhere .= " " . $rule->clause . " ";
