...
get_header(); ?>
		...
		<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
						...
						<div class="aproduct aproduct<?php echo $i; ?>">
							...
							<?php if(get_sub_field('hire_link') != NULL): ?>
								<div class="ahire">
									...
									<br style="clear: both;" />
									<span><?php echo get_sub_field('hire_price'); ?></span>
								</div>
							<?php endif; ?>
			 ...
			 <div id="page">
				...
				<!-- <?php if(get_field('commercial_fitness_image') != NULL): ?>
					<div id="commercial_banner" style="background-image: url(<?php echo get_field('commercial_fitness_image'); ?>);">
						<a href="/commercial-fitness/" class="cbtop">Click here for commercial solutions</a><br />
						<a href="/commercial-fitness/">Click here for our Commercial Fitness Solutions</a>
					</div>
				<?php endif; ?> -->
			...
			<div id="page">				
				<!-- <h2 class="h2-home">Our fitness equipment services</h2> -->
