	...
	if ( $count > 0 ) {
		...
		if($rate[0] == 5):
			echo '	<img src="/wp-content/themes/chandler/images/gold_star.png" class="astar" />
					...
					<img src="/wp-content/themes/chandler/images/gold_star.png" class="astar" />
			';
			echo '<span style="font-size: 10px;">'.$count.' '; if($count == 1): echo 'reviews'; else: echo 'reviews'; endif; echo '</span>';
		endif;
...
##########################################################
	...
	function social_share() {
		...
		$out .= '<a href="http://www.facebook.com/sharer.php?u='.get_the_permalink().'" class="share-facebook" target="_blank">Share on FaceBook</a>';
		
		$out .= '<a href="http://www.twitter.com/share?text='.get_the_title().' - '.get_bloginfo('name').'&url='.get_the_permalink().'" class="share-twitter" target="_blank">Share on Twitter</a>';
		
		$out .= '<a href="http://pinterest.com/pin/create/button/?url='.get_the_permalink().'&media='.$image[0].'&description=" class="share-pin" target="_blank">Share on Pinterest</a>';
		$out .= '</div>';
		echo $out;
	}
